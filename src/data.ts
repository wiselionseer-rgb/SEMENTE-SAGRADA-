...
export const SEEDS: Seed[] = [
  { 
    ...
    image: '/images/acai_chocolate_punch.jpg', 
    gallery: ['/images/acai_chocolate_punch.jpg', '/images/acai_fem.jpg', '/images/acai_auto_gallery.jpg'],
    category: 'best', 
    rating: '5.0',
    reviews: 124,
  ...
  { 
    ...
    gallery: ['/images/bbb.jpg', '/images/sjj_gallery.jpg', '/images/bbb_auto_gallery.jpg'],
    category: 'best', 
    rating: '4.9',
    reviews: 89,
  ...
  { 
    ...
    stages: ['Germinação', 'Muda', 'Vegetativo', 'Pré-floração', 'Floração', 'Colheita'], 
    stageAt: [0, 10, 20, 35, 45, 60], 
    image: '/images/grr1.jpg', 
    gallery: ['/images/grr1.jpg', '/images/grr_gallery.jpg', '/images/grr_auto_gallery.jpg'],
    category: 'best', 
    rating: '5.0',
    reviews: 156,
    prices: { 'X2': '70,00', 'X4': '110,00', 'X7': '170,00', 'X12': '240,00', 'X50': '750,00', 'X100': '1250,00' },
  ...
  { 
    ...
    stages: ['Germinação', 'Muda', 'Vegetativo', 'Pré-floração', 'Floração', 'Colheita'], 
    stageAt: [0, 10, 20, 35, 45, 60], 
    image: '/images/ggm1.jpg', 
    gallery: ['/images/ggm1.jpg', '/images/ggm_gallery.jpg', '/images/ggm_auto_gallery.jpg'],
    category: 'best', 
    rating: '4.9',
    reviews: 72,
    prices: { 'X2': '70,00', 'X4': '110,00', 'X7': '170,00', 'X12': '240,00', 'X50': '750,00', 'X100': '1250,00' },
  ...
  { 
    ...
    stages: ['Germinação', 'Muda', 'Vegetativo', 'Pré-floração', 'Floração', 'Colheita'], 
    stageAt: [0, 10, 20, 35, 45, 60], 
    image: '/images/sjj1.jpg', 
    gallery: ['/images/sjj1.jpg', '/images/sjj_fem_gallery.jpg', '/images/bbb_gallery.jpg'],
    category: 'best', 
    rating: '5.0',
    reviews: 213,
    prices: { 'X2': '70,00', 'X4': '110,00', 'X7': '170,00', 'X12': '240,00', 'X50': '750,00', 'X100': '1250,00' },
  ...
  { 
    ...
    stages: ['Germinação', 'Muda', 'Vegetativo', 'Pré-floração', 'Floração', 'Colheita'], 
    stageAt: [0, 10, 20, 35, 45, 60], 
    image: '/images/ssr1.jpg', 
    gallery: ['/images/ssr1.jpg', '/images/ssr_gallery.jpg', '/images/ssr_auto_gallery.jpg'],
    category: 'best', 
    rating: '4.9',
    reviews: 104,
    prices: { 'X2': '70,00', 'X4': '110,00', 'X7': '170,00', 'X12': '240,00', 'X50': '750,00', 'X100': '1250,00' },
