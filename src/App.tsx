        ...
        <div className="w-full bg-[#0a000a] relative overflow-hidden py-16 lg:py-24 shadow-[inset_0_0_80px_rgba(0,0,0,0.9)] border-b-8 border-double border-[#ff00ff]">
           ...
           <div className="max-w-[1200px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between relative z-20">
              ...
              <div className="relative w-full max-w-[400px] h-[300px]">
                 ...
                 <img src="/gifs/Design sem nome (2).gif" className="absolute right-0 top-1/2 -translate-y-1/2 w-[280px] lg:w-[380px] drop-shadow-[0_0_40px_rgba(255,0,255,0.4)] pixelate z-10 hover:scale-[1.02] transition-transform duration-500" alt="Hero Mascot" />
                 <img src="/gifs/VERDE ESCURA.png" className="absolute left-0 lg:-left-12 top-0 w-[90px] drop-shadow-xl animate-[bounce_4s_infinite] pixelate z-20 bg-lime-500/10 rounded-full p-2 border-2 border-lime-500/30 backdrop-blur-sm" alt="Floating Seed" />
