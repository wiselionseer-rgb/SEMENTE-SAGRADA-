...
export default function App() {
  ...
  const [isAgeVerified, setIsAgeVerified] = useState<boolean>(() => {
    return localStorage.getItem('age-verification-seed-v2') === 'true';
  });
    ...
    <div className="font-[Comic Neue] min-h-screen text-[var(--green)]">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-6">
                   <div 
                     onClick={() => {
                        playSfx('click');
                        setOpenMegaMenu(null);
                        setActiveFilter('Semente Sagrada World');
                   ...
                   >
                      <div className="w-16 h-16 rounded-full flex items-center justify-center">
                         <img src="https://seedscountry.com/wp-content/uploads/2021/04/highbreed-logo.png" alt="Semente Sagrada World" className="w-full h-full object-contain grayscale hover:grayscale-0 transition-all drop-shadow" onError={(e) => { e.currentTarget.style.display = 'none'; e.currentTarget.parentElement!.innerHTML = '<span class="text-4xl text-lime-600">🌱</span>'; }} />
                      </div>
                      <span className="font-bold text-[10px] md:text-xs uppercase tracking-widest text-[#111]">Semente Sagrada World</span>
                   </div>
                </div>
              </div>
            </div>
      ...
      <>
        ...
        <div className="bg-[#050505]/90 border-2 border-lime-500/20 p-8 rounded-3xl backdrop-blur-3xl relative overflow-hidden group/elite-section">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-green-950/20 via-black to-green-900/20 pointer-events-none"></div>
          
          {/* GLOWING ORBS */}
          <div className="absolute -top-24 -left-24 w-64 h-64 bg-lime-500/10 blur-[100px] rounded-full animate-pulse"></div>
          <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-lime-500/10 blur-[100px] rounded-full animate-pulse"></div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-20">
            ...
            <div className="flex-1 text-center md:text-left order-2 md:order-1">
              ...
              <div className="mb-8 flex justify-center md:justify-start">
                <div className="bg-black/40 border-2 border-lime-500/40 px-4 py-1.5 rounded-full flex items-center gap-3 hover:border-lime-500 transition-all group/banner-top cursor-default shadow-[0_0_20px_rgba(0,255,0,0.1)]">
                  <span className="text-lg group-hover/banner-top:scale-125 transition-transform">🚚</span>
                  <div className="flex flex-col">
                    <span className="pixel text-[8px] text-lime-400 font-black tracking-[0.2em]">FRETE GRÁTIS</span>
                    <span className="vt text-[9px] text-white/60 font-bold uppercase tracking-widest">PARA TODO O BRASIL!</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                ...
                <span className="pixel text-[10px] text-lime-400 font-black tracking-[0.4em] uppercase">
                  INSTITUTO DE GENÉTICA
                </span>
              </div>
              <h2 className="vt text-5xl md:text-7xl text-white font-black uppercase tracking-tighter leading-[0.8] mb-6 drop-shadow-[0_0_20px_rgba(0,255,0,0.3)]">
                Sementes<br/><span className="text-lime-500">de Elite</span>
              </h2>
              <p className="vt text-lg md:text-xl text-white/60 max-sm leading-tight mb-8">
                A seleção definitiva para cultivadores que buscam o topo da pirâmide genética. Estabilidade garantida e potência máxima.
              </p>
              
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                <div className="bg-white/5 border border-white/10 px-4 py-2 rounded-xl flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-lime-500 animate-ping"></div>
                  <span className="vt text-xs text-white uppercase tracking-widest font-black">LOTE 2026 ATIVO</span>
                </div>
                <div className="bg-lime-500 text-black px-6 py-2 rounded-xl flex items-center gap-2 cursor-pointer hover:bg-white transition-all transform hover:scale-105 active:scale-95" onClick={() => { playSfx('click'); document.getElementById('catalog')?.scrollIntoView({ behavior: 'smooth' }); }}>
                  <span className="pixel text-[10px] font-black">EXPLORAR CATÁLOGO</span>
                </div>
              </div>

              {/* BOTTOM BANNER: SEMENTE GRÁTIS */}
              <div className="mt-10 flex justify-center md:justify-start">
                <div className="bg-gradient-to-r from-lime-500/10 to-transparent border-l-4 border-lime-500 px-5 py-3 flex items-center gap-4 hover:from-lime-500/20 transition-all cursor-default group/banner-bot">
                  <span className="text-2xl group-hover/banner-bot:rotate-12 transition-transform">🎁</span>
                  <div className="flex flex-col">
                      <span className="pixel text-[10px] text-white font-black tracking-widest">SEMENTE GRÁTIS</span>
                      <span className="vt text-[11px] text-lime-400 font-black uppercase tracking-[0.2em] animate-pulse">TODOS OS DIAS EM TODOS OS PEDIDOS</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* RIGHT SIDE: THE MASCOT CARD */}
            <div 
              className="w-full md:w-[280px] p-6 border-2 border-lime-500/40 bg-black rounded-3xl flex flex-col items-center justify-center relative overflow-hidden shadow-[0_0_60px_rgba(0,255,0,0.15)] group/elite-header transition-all hover:border-lime-500 order-3"
            >
              <div className="absolute inset-0 bg-gradient-to-t from-lime-500/10 to-transparent"></div>
              
              <div className="w-full aspect-square flex items-center justify-center relative my-2 transform group-hover/elite-header:scale-105 transition-transform duration-700">
                <div className="absolute inset-0 bg-lime-500/20 blur-[60px] rounded-full scale-50"></div>
                <img src="/gifs/design_sem_nome_4.gif" alt="elite-gif" className="w-[80%] h-[80%] object-contain filter drop-shadow-[0_0_30px_#00ff00] contrast-125 z-10" />
              </div>

              <div className="flex flex-col items-center gap-1 w-full relative z-10 mt-2">
                <div className="h-[2px] w-12 bg-lime-500 mb-2"></div>
                <span className="pixel text-[9px] text-yellow-400 font-black tracking-[0.3em] uppercase animate-pulse">
                  MASTER SOURCE
                </span>
                <span className="vt text-xs text-white/30 uppercase tracking-[.5em] font-bold mt-1">ID: ELITE-V5</span>
              </div>
            </div>
          </div>
        </div>
           ...
           <div className="max-w-[1200px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between relative z-20">
              <div className="text-white max-w-xl text-center md:text-left mb-12 md:mb-0">
                 ...
                 <div className="mt-8 flex items-center justify-center md:justify-start gap-3 bg-black/40 inline-flex px-4 py-2 border border-white/10 rounded-sm">
                   ...
                   <p className="vt text-xs opacity-70 uppercase tracking-widest text-[#fff] font-bold">FRETE GRÁTIS EM PEDIDOS ACIMA DE R$ 680</p>
                 </div>
              </div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 relative z-10 text-center pt-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 mb-16 text-left" id="catalog">
            {SEEDS.filter(seed => {
              ...
              switch (activeFilter) {
                case 'Semente Sagrada World': return true;
      ...
      <div className="w-full bg-[#000] py-8 border-y-[6px] border-double border-[#660066]">
          <div className="text-center flex flex-col items-center gap-4">
              <div className="pixel text-lg text-purple-400 animate-pulse">▼▼▼ JOGAR AGORA! ▼▼▼</div>
              ...
              <div className="flex flex-wrap justify-center items-center gap-4">
                ...
                <div className="flex gap-2 bg-black/40 p-2 rounded-lg border border-white/5 backdrop-blur-md relative z-50">
                  <div className="relative">
                    ...
                    {speedMenuOpen && (
                      <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 bg-[#001800] border-4 border-[#ffaa00] p-3 z-[1000] text-left min-w-[200px] shadow-[0_10px_30px_rgba(0,0,0,0.9)]">
                        <div className="pixel text-[10px] text-yellow-300 mb-3 border-b border-[#333] pb-2 uppercase text-center">VELOCIDADE DO TEMPO</div>
                        {[1, 5, 20, 60].map(v => (
                          <button key={v} onMouseEnter={() => playSfx('hover')} onClick={() => { playSfx('click'); setG(p => ({...p, speed: v})); setSpeedMenuOpen(false); }} className={`block w-full px-3 py-2 bg-[#001100] border-2 border-[#004400] vt text-lg mb-2 hover:bg-[#003300] transition-colors ${G.speed === v ? 'text-yellow-300 border-yellow-300 shadow-[0_0_10px_rgba(255,255,0,0.3)]' : 'text-orange-400'}`}>
                  ...
                  <button className="pixel text-[10px] px-3 py-2 border-[2px] transition-all text-cyan-400 border-cyan-400 hover:bg-[#001122] hover:scale-105 active:scale-95 bg-black" onMouseEnter={() => playSfx('hover')} onClick={() => { playSfx('click'); setPopup({title: '❓ COMO JOGAR', body: <>Plante, regue, adube, espere crescer e colha!<br/>Cuidado para não secar!</>})}}>
                    ❓ AJUDA
                  </button>
                  <button className="pixel text-[10px] px-3 py-2 border-[2px] transition-all text-red-500 border-red-500 hover:bg-[#220000] hover:text-white hover:scale-105 active:scale-95 bg-black" onMouseEnter={() => playSfx('hover')} onClick={() => { playSfx('click'); resetGame(); }}>
                    ↺ RESETAR
                  </button>
                </div>
              </div>

              {/* SEED SELECTION MOVED HERE */}
              <div id="catalog-selection" className="w-full max-w-[1240px] mx-auto overflow-x-auto horizontal-scroll-custom no-scrollbar px-4 py-6">
                <div className="flex gap-6 items-stretch">
                   {SEEDS.filter(seed => {
                      ...
                      <div 
                        key={i} 
                        className={`min-w-[260px] md:min-w-[320px] p-6 border-2 transition-all cursor-pointer rounded-2xl flex flex-col justify-between relative group/seed-card overflow-hidden backdrop-blur-xl ${G.selSeed === i ? 'border-lime-400 bg-lime-500/10 shadow-[0_0_50px_rgba(0,255,0,0.3)] scale-[1.02] z-20' : 'border-white/5 bg-white/5 opacity-80 hover:opacity-100 hover:bg-white/10 hover:border-white/20'}`} 
                        onClick={() => { 
                          playSfx('click'); 
                      ...
                      >
                        ...
                        <div className="absolute top-4 left-4 z-30">
                          <span className={`pixel text-[8px] px-3 py-1.5 rounded-sm shadow-xl ${seed.badge === 'RARE' ? 'bg-purple-600' : 'bg-lime-500'} text-black font-black`}>
                            {seed.badge}
                          </span>
                        </div>

                        <div className="flex flex-col items-center mb-6 relative z-10">
                           <div className="w-full aspect-square bg-gradient-to-br from-black to-green-950 flex items-center justify-center border border-white/10 mb-5 overflow-hidden rounded-xl relative group-hover/seed-card:border-lime-500/40 transition-all duration-700 shadow-2xl">
                              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,255,0,0.15)_0%,transparent_70%)]"></div>
                              <img src={`${window.location.origin}${seed.image}`} alt={seed.name} className="w-[85%] h-[85%] object-cover rounded-xl shadow-2xl transition-transform duration-700 group-hover/seed-card:scale-110 relative z-10 border-2 border-white/10" />
                              <div className="absolute bottom-3 right-3 z-20">
                                 {G.selSeed === i && <div className="w-4 h-4 rounded-full bg-lime-400 shadow-[0_0_20px_#00ff00] animate-pulse"></div>}
                              </div>
                           </div>
                           
                           <span className="vt text-[20px] md:text-[24px] font-black text-center leading-none uppercase tracking-[0.1em] transition-all group-hover/seed-card:text-white drop-shadow-[0_2px_15px_rgba(0,0,0,1)]" style={{color: G.selSeed === i ? 'white' : seed.color}}>
                              {seed.name}
                           </span>
                           <span className="vt text-[10px] text-white/40 uppercase tracking-[0.4em] mt-2 font-bold">SELEÇÃO PREMIUM</span>
                        </div>
                        
                        <div className="flex flex-col gap-4 mt-auto relative z-10 p-4 rounded-xl border border-white/5 bg-black/60 backdrop-blur-md">
                          <div className="grid grid-cols-2 gap-3">
                            <div className="flex flex-col gap-1">
                              <span className="text-white/30 text-[9px] uppercase font-black tracking-tighter">LINHAGEM</span>
                              <select value={variant.type} onClick={(e) => e.stopPropagation()} onChange={handleChangeType} className="bg-neutral-900 text-white border border-white/10 rounded-md px-2 py-2 outline-none cursor-pointer text-[10px] font-black hover:border-lime-400 transition-all focus:ring-1 focus:ring-lime-400">
                                <option value="Feminizada">Feminizada</option>
                                <option value="Automatica">Automática</option>
                              </select>
                            </div>
                            <div className="flex flex-col gap-1">
                              <span className="text-white/30 text-[9px] uppercase font-black tracking-tighter">PACK</span>
                              <select value={variant.qty} onClick={(e) => e.stopPropagation()} onChange={handleChangeQty} className="bg-neutral-900 text-white border border-white/10 rounded-md px-2 py-2 outline-none cursor-pointer text-[10px] font-black hover:border-lime-400 transition-all focus:ring-1 focus:ring-lime-400">
                                {QUANTITIES.map(q => <option key={q} value={q}>{getQtyLabel(q)}</option>)}
                              </select>
                            </div>
                          </div>

                          <div className="flex justify-between items-end vt mt-2 pt-4 border-t border-white/10">
                             <div className="flex flex-col">
                               <span className="text-white/30 uppercase font-black text-[9px] tracking-widest leading-none mb-1">CUSTO SEMENTES</span>
                               <div className="flex items-center gap-1">
                                <span className="text-[11px] text-lime-500 font-black">R$</span>
                                <span className="text-white font-black tracking-[0.1em] text-2xl leading-none">
                                  {seed.prices[variant.qty]}
                                </span>
                               </div>
                             </div>
                             <div className={`px-4 py-2 rounded-lg text-[10px] font-black transition-all ${G.selSeed === i ? 'bg-lime-500 text-black shadow-[0_0_20px_#00ff00]' : 'border border-lime-500/30 text-lime-400 bg-lime-500/5 group-hover:bg-lime-500 group-hover:text-black'}`}>
                               {G.selSeed === i ? 'SELECIONADO' : 'ESCOLHER'}
                             </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="lg:w-[60%] xl:w-[55%] flex-1 lg:h-full overflow-y-auto overscroll-contain flex flex-col bg-[#050505] scrollbar-thin scrollbar-thumb-[#333] scrollbar-track-transparent [-webkit-overflow-scrolling:touch]">
                ...
                <div className="flex flex-col xl:flex-row border-b border-[#222]">
                  ...
                  <div className="xl:w-[55%] p-6 md:p-8 flex flex-col border-b xl:border-b-0 xl:border-r border-[#222] lg:min-h-[60vh]">
                    <div className="text-[10px] md:text-xs text-lime-600 mb-4 flex flex-wrap gap-1 md:gap-2 uppercase font-bold tracking-wider">
                       ...
                       <span>Semente Sagrada World</span> <span className="text-[#444]">—</span> 
                    ...
                    <div className="flex flex-col text-sm border-t border-[#222]">
                       {[
                         ['Marca', 'Semente Sagrada World', true],
                  ...
                  <div className="xl:w-[45%] p-6 md:p-8 bg-[#0a0a0a] flex flex-col relative w-full lg:sticky top-0 h-fit lg:min-h-[60vh]">
                     ...
                     <div className="bg-[#111] border border-lime-900/40 rounded-xl p-4 flex flex-col gap-2 mb-6 shadow-inner">
                        ...
                        <div className="bg-[#000] border border-[#222] px-3 py-2 rounded text-xs font-black text-lime-500 tracking-wider flex justify-between uppercase">SAGRADAWORLD <span className="cursor-pointer text-gray-500 hover:text-white">📋</span></div>
                     </div>
                ...
                <div className="p-6 md:p-10 lg:p-14 flex flex-col gap-12 bg-[#050505]">
                    ...
                    <div>
                       ...
                       <p className="text-gray-400 text-sm md:text-base leading-[1.8] tracking-wide">
                           Aproveite a facilidade de cultivar a cannabis mais potente do mundo com nossas sementes {variant.type.toLowerCase()}s! Com a confiança de milhares de growers em todo o Brasil e Portugal, a Semente Sagrada World é a sua fonte de sementes de qualidade da {seed.name}. Compre online hoje mesmo e comece sua aventura no cultivo!
                       </p>
                    </div>
                    ...
                    <div>
                       ...
                       <div className="flex flex-col gap-6">
                           <div>
                               ...
                               <p className="text-gray-400 text-sm md:text-base leading-[1.8] tracking-wide">Sim. Na Semente Sagrada World, as sementes de cannabis são vendidas como souvenirs colecionáveis. Pedimos que verifique as leis locais antes de fazer o pedido, pois ao encomendar, confirma que está a cumpri-las.</p>
                           </div>
                    ...
                    {/* Porquê Comprar */}
                    <div>
                       <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Porquê Comprar Sementes da Semente Sagrada World</h3>
                       <ul className="list-disc pl-6 text-gray-400 text-sm md:text-base leading-[1.8] tracking-wide space-y-2">
                        ...
                        <div className="bg-[#2E7D32] text-white p-8 md:p-12 pb-20 font-sans">
                            ...
                            <div className="max-w-5xl mx-auto border-t border-[#4CAF50] pt-10">
                                <p className="text-[10px] md:text-xs text-[#C8E6C9] leading-relaxed font-medium mb-10 text-justify">
                                    Na Semente Sagrada World, são vendidas sementes de cannabis como souvenirs, as quais não devem ser germinadas onde sejam ilegais. Ao comprá-las, você confirma que tem a idade legal para isso e está ciente das legislações e regulamentações locais. A Semente Sagrada World não é responsável por quaisquer violações da lei. Os produtos e as informações contidas neste site não foram avaliados pela Anvisa/FDA e NÃO têm a pretensão de diagnosticar, tratar, curar ou prevenir qualquer enfermidade. Todos os produtos contêm menos de 0,3% de THC, quando aplicável, de acordo com as regulamentações locais. Por favor, certifique-se da conformidade com suas leis locais, já que a Semente Sagrada World não oferece aconselhamento legal e não assume qualquer responsabilidade pelo uso ou cultivo de cannabis em áreas onde isso é proibido.
                                </p>
                                <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-6 text-xs font-bold text-[#E8F5E9]">
                                    <div className="flex items-center gap-4">
                                        <div className="text-3xl font-black font-sans tracking-tighter text-white">Semente Sagrada World<span className="text-lime-400">.</span></div>
                                    ...
                                    <div className="text-center md:text-right flex flex-col items-center md:items-end leading-relaxed text-[10px]">
                                        ...
                                        <span className="text-[#A5D6A7]"> — Diretamente pela Semente Sagrada World Ltd.</span>
                                        <span className="text-[#A5D6A7]"> — Através do nosso provedor de serviços de pagamento, com número de ID fiscal local.</span>
                                        <span className="mt-3 text-white">Copyright © 2007-{(new Date().getFullYear())} Semente Sagrada World</span>
                                    </div>
